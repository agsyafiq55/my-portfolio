...
export default function ThreeDMarqueeDemo() {
  ...
  const images = [
    ...
    "/3dmarquee/facility2.png",
    "/3dmarquee/kkhsbog2.png",
    "/3dmarquee/ticket1.png",
    "/3dmarquee/ums-tourism.png",
   ...
   "/3dmarquee/webar.png",
    ...
    "/3dmarquee/ticket1.png",
    "/3dmarquee/ums-tourism.png",
    // Add more duplicates for better coverage
    "/3dmarquee/webar.png",
    "/3dmarquee/webvr.png",
    "/3dmarquee/kkhs_facility.png",
    "/3dmarquee/kkhs_facility2.png",
    ...
    "/3dmarquee/ticket1.png",
    "/3dmarquee/ums-tourism.png",
    // Additional duplicates for even better distribution
    "/3dmarquee/webar.png",
    "/3dmarquee/webvr.png",
    "/3dmarquee/kkhs_facility.png",
    "/3dmarquee/kkhs_facility2.png",
